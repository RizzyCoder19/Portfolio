...
const content = [
  ...
  `  introBeamBrightenDuration,`,
  `  introBeamFadeDelay,`,
  `  introBeamFadeDuration,`,
  `  introBeamGrowDelay,`,
  `  introBeamGrowDuration,`,
  `  introBeamRestDuration,`,
  `  introDoneDelay,`,
  `  introFinalPause,`,
  `  introHoldDelay,`,
  `  introHoldDuration,`,
  `  introLine1FadeDelay,`,
  `  introLine1FadeDuration,`,
  `  introLine2FadeDelay,`,
  `  introLine2FadeDuration,`,
  `  introStatement,`,
  `  introTextFadeDelay,`,
...
writeFileSync("src/components/experience/IntroScreen.tsx", content, "utf-8");
